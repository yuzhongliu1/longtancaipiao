...
def main():
    ...
    if mode == "1":
        ...
        if not parts_desc:
            ...
            result_lines.append(f"{today_str}，{parts_desc[0]}，扣佣后{fmt_num(kouyong_ta_da if ta_da else kouyong_wo_da)}元")
    ...
    st.markdown("<h4>结算结果右上角可复制</h4>", unsafe_allow_html=True)
